...
<head>
  ...
  <meta
    name="description"
    content="Vesuvius Challenge scanning tutorial: explore a CT-scanned Herculaneum scroll volume in Fiji, view the “word soup,” and export a 3D mesh in MeshLab."
  />
